<?php
    function commentEmail($commenter, $imageid, $text) {
        ...
        $message = $commenter.' has commented on your post.<br>They said the following: '.$text.'<br>Go to the following link to reply: http://localhost:80/camagru/user.php?name='.$results['username'];
